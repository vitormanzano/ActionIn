...
## Description
An authenticated user should be able to start a action.
...
2. User clicks the button Action.
3. User fills in title, optional description.
...
## Post-conditions
- Action is created and persisted.
